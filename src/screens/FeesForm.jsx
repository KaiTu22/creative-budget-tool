...
export default function FeesForm({ existingPackage, onSave, onCancel }) {
  ...
  function stepStatus(stepNum) {
    switch (stepNum) {
      ...
      case 3: return !totalInvestment ? 'locked' : 'active'
  ...
  return (
    <div className="page" style={{ maxWidth: '860px' }}>
      <div className="page-header">
        ...
        <h1>{ep ? 'Edit' : 'New'} Fees Package</h1>
      ...
      <StepCard number={2} title="Investment" status={stepStatus(2)}>
        <label style={{ fontSize: '0.78rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'block', marginBottom: '0.5rem' }}>
          Total Investment <span style={{ color: 'var(--danger)' }}>*</span>
        </label>
      ...
      <StepCard number={3} title="Notes" status={stepStatus(3)}>
        <div className="form-group">
          <textarea
            value={notes}
